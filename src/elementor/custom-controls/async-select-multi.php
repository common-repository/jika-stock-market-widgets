...
class Jika_Widgets_Elementor_Async_Select_Multi extends \Elementor\Control_Base_Multiple
{
	use JikaWidgetsEnv;
...
?>
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<div class="elementor-control-async-select elementor-control-async-select-multi <?php echo esc_attr($control_uid) ?>"></div>
			</div>
		</div>
		<# if ( data.description ) { #>
