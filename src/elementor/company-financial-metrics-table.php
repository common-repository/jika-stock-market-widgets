...
class JikaWidgetsElementorCompanyFinancialMetricsTable extends Widget_Base
{
	use JikaWidgetsElementor;

	public static $slug = 'company-financial-metrics-table';
	public static $title = 'Company Financial Metrics Table';
	...
	protected function render()
	{
		...
		$jika_widgets_sort_method = $this->get_settings_for_display('widget_sort_method');
		...
		$this->generate_iframe('fundamentals-table', [
			...
			'to' => $jika_widgets_to,
			'sortMethod' => $jika_widgets_sort_method,
...
$jika_widgets_elementor_company_financial_metrics_table = new JikaWidgetsElementorCompanyFinancialMetricsTable();
